<template>
  <div>
    <group title="需求抬头" labelWidth="6.5rem" gutter="0" labelMarginRight="1rem">
      <cell title="需求编号" v-model="infos.name" value-align="right"></cell>
      <datetime title="创建时间" v-model="alldate" format="YYYY-MM-DD"></datetime>
      <popup-picker title="业务类别" :data="list3" v-model="infos.racky" :columns="1" show-name value-text-align="right"></popup-picker>
      <popup-picker title="需求类型" :data="list3" v-model="infos.racky" :columns="1" show-name value-text-align="right"></popup-picker>
      <popup-picker title="销售范围" :data="list3" v-model="infos.racky" :columns="1" show-name value-text-align="right"></popup-picker>
      <popup-picker title="销售部门" :data="list3" v-model="infos.racky" :columns="1" show-name value-text-align="right"></popup-picker>
      <popup-picker title="客户名称" :data="list3" v-model="infos.racky" :columns="1" show-name value-text-align="right"></popup-picker>
      <cell title="需求编号" v-model="infos.name" value-align="right"></cell>
      <popup-picker title="货币" :data="list3" v-model="infos.racky" :columns="1" show-name value-text-align="right"></popup-picker>
      <x-input title="汇率" v-model="infos.emailFrom" text-align="center"></x-input>
    </group>
    <group title="明细信息" labelWidth="6.5rem" gutter="0" labelMarginRight="1rem">
